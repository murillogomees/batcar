...
<html lang="pt-BR">
    <head>
        ...
        <link rel="stylesheet" href="<?= APPURL . '/assets/css/talk-us.css'?>">
...
<?php require_once(APPPATH.'/views/fragments/settings/google-analytics.fragment.php'); ?>
    ...
    <body data-scroll-animation="true">
      ...
      <?php require_once(APPPATH.'/views/fragments/contato.fragment.php'); ?>
        ...
        <script src="<?= APPURL . '/assets/js/contact.js'?>"></script>
