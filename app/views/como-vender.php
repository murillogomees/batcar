...
<?php require_once(APPPATH.'/views/fragments/settings/google-analytics.fragment.php'); ?>
    ...
    <body data-scroll-animation="true" style="background: #0f1216;">
      ...
      <?php require_once(APPPATH.'/views/fragments/como-vender.fragment.php'); ?>
        ...
        <script src="<?= APPURL . '/assets/js/como-vender.js'?>"></script>
