                ...
                <div class="section-content">
                    ...
                    <div class="clearfix">
                        <div class="col s12 m12 l4">
                            ...
                            <div class="mb-20 col s12 m12 l4">
                                ...
                                <input class="input"
                                          ...
                                          maxlength="255"
                                          rows="3"
                                       value="<?= htmlchars($Settings->get("data.site_description")) ?>">
                            ...
                            <div class="mb-40 col s12 m12 l4 l-last">
                                ...
                                <input class="input"
                                          ...
                                          maxlength="500"
                                          rows="3"
                                       value="<?= htmlchars($Settings->get("data.site_keywords")) ?>">
                            </div>
                        </div>
